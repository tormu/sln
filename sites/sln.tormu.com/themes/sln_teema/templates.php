 ...
 */
function sln_teema_preprocess_page(&$vars, $hook) {
  ...
  $vars['css_alt'] = sln_teema_css_reorder($vars['css']);
 ...
 * weighted styles.
 */
function sln_teema_css_reorder($css) {
...
drupal_add_js(path_to_theme() . '/js/jquery.geturlparam.js');
drupal_add_js(path_to_theme() . '/js/jquery.tablesorter.min.js');
drupal_add_js(path_to_theme() . '/js/autoHeight.js');
drupal_add_js(path_to_theme() . '/js/sln_teema.js');